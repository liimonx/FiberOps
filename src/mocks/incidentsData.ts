...
const seedIncidents: Incident[] = [
  ...
  {
    id: "inc-005",
    title: "Splitter failure - Gulshan zone",
    severity: "high",
    status: "resolved",
    relatedAssetId: "split-gulshan-01",
    technician: technicians[0],
    notes: "Replaced failed splitter module. All downstream ONTs restored.",
    resolutionNotes: "Splitter module replaced. Signal levels normalized.",
    createdAt: hoursAgo(168),
    updatedAt: hoursAgo(156),
    resolvedAt: hoursAgo(156),
  },
  {
    id: "inc-006",
    title: "Power outage at Banani junction",
    severity: "medium",
    status: "resolved",
    relatedAssetId: "jb-banani-01",
    technician: technicians[1],
    notes: "UPS failover engaged. Battery replaced on site.",
    resolutionNotes: "UPS battery replaced. Junction box back on primary power.",
    createdAt: hoursAgo(336),
    updatedAt: hoursAgo(320),
    resolvedAt: hoursAgo(320),
  },
  {
    id: "inc-007",
    title: "Intermittent packet loss - Tejgaon hub",
    severity: "low",
    status: "resolved",
    relatedAssetId: "jb-tejgaon-01",
    technician: technicians[2],
    notes: "Loose fiber connector tightened during routine inspection.",
    resolutionNotes: "Connector re-seated. Packet loss cleared.",
    createdAt: hoursAgo(504),
    updatedAt: hoursAgo(490),
    resolvedAt: hoursAgo(490),
  },
];
