...
import { Card, Container, Button, Tabs, Input } from "@shohojdhara/atomix";
  ...
  return (
    <Container className="u-py-6 u-w-100">
      <div className="u-flex u-justify-between u-items-center u-mb-6">
        <div>
          <h1 className="u-text-xxl u-font-bold u-mb-2">System Settings</h1>
          ...
          <Tabs.Panels>
            <Tabs.Panel index={0}>
              <div className="u-w-lg-50 u-flex u-flex-column u-gap-4">
                <div>
                  <label className="u-font-bold u-text-sm u-mb-2 u-block">
                    Organization Name
                  </label>
