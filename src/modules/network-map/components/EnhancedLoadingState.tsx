  ...
  const content = (
    <div className="u-flex u-flex-column u-items-center u-gap-3">
      ...
      <div className="u-text-center">
        <span
          className={`u-text-${size === "sm" ? "xs" : size === "lg" ? "base" : "sm"} u-font-bold u-text-primary`}
        >
          {message}
        ...
        {subMessage && (
          <p className="u-text-xs u-text-secondary-subtle u-mt-1 u-opacity-70">
            {subMessage}
          </p>
        )}
      </div>
      ...
      {showProgress && progress !== undefined && (
        <div className="u-w-100 u-mt-4" style={{ minWidth: "200px" }}>
          <div className="u-flex u-justify-between u-text-xs u-text-secondary-subtle u-mb-2">
            <span
    ...
    return (
      <div className="u-fixed u-inset-0 u-flex u-items-center u-justify-center u-bg-dark u-z-modal">
        <div className="u-flex u-flex-column u-items-center u-gap-6">
          <Icon name="SpinnerGap" size={64} className="u-text-primary u-animate-spin" />
          <div className="u-text-center">
            <h2
              className="u-m-0 u-text-2xl u-font-bold u-text-primary u-text-uppercase"
              style={{ letterSpacing: "4px" }}
            >
              {message}
            </h2>
            {subMessage && (
              <p className="u-mt-2 u-text-sm u-text-secondary-subtle">{subMessage}</p>
            )}
          </div>
          {showProgress && progress !== undefined && (
