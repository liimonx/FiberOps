      ...
      <Card glass={true} style={{ width: "300px" }}>
        ...
        <div className="u-flex u-justify-between u-items-center u-mb-4 u-pb-2 u-border-bottom u-border-secondary-subtle">
          <div className="u-flex u-items-center u-gap-2 u-px-2 u-py-1 u-bg-white-opacity-5 u-rounded u-border u-border-solid u-border-secondary-subtle">
            <Icon name={getNodeIcon() as any} size={16} className="u-text-primary" />
            <span
              className="u-text-xs u-font-bold u-text-uppercase u-text-primary"
        ...
        <div className="u-flex u-flex-column u-gap-3 u-mb-4">
          ...
          <div className="u-flex u-justify-between u-items-center">
            ...
            <span className="u-text-sm u-font-bold u-text-primary">{name}</span>
          </div>
          {location?.address && (
            <div className="u-flex u-flex-column u-gap-1">
              ...
              <span className="u-text-xs u-text-primary u-opacity-80">
                {location.address}
              </span>
            </div>
          )}
        ...
        {(capacity || utilization !== undefined) && (
          <div className="u-p-3 u-bg-white-opacity-5 u-rounded u-border u-border-solid u-border-secondary-subtle u-mb-4">
            <h4 className="u-m-0 u-text-xs u-font-bold u-text-primary u-text-uppercase u-mb-3">
              Live Metrics
            </h4>
            {capacity && (
              <div className="u-flex u-justify-between u-items-center u-mb-2">
                <span className="u-text-xs u-text-secondary-subtle">Capacity</span>
            ...
            {utilization !== undefined && (
              <div className="u-flex u-flex-column u-gap-2">
                <div className="u-flex u-justify-between u-items-center">
                  <span className="u-text-xs u-text-secondary-subtle">Utilization</span>
                  <span className="u-text-xs u-font-bold u-text-primary">
                    {utilization}%
                  </span>
                </div>
        ...
        {/* Metadata */}
        <div className="u-flex u-items-center u-gap-2 u-text-xs u-text-secondary-subtle u-opacity-60">
